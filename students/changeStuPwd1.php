...
<div id="wrap">
    ...
    <div id="content">
        ...
        <div class="page">
            <iframe width="100%" scrolling="auto" height="100%" frameborder="true" allowtransparency="true" style="border: medium none;" src="changeStuPwd.php" id="rightMain" name="right">
            </iframe>
        </div>
    </div><!--#content -->
    <div class="clear"></div>
